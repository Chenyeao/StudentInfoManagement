...
<head>
	...
	<script type="text/javascript" src="/static/jquery-easyui-1.3.3/datagrid-scrollview.js"></script>
...
//            "page="+page+"&rows="+rows+
        ...
        function openStudentAddDialog(){
            ...
            resetValue();
            controllerurl="/management/addStudent";
        }
...
//						alert("添加成功");;
        ...
        function openStudentModifyDialog(){
            ...
            $("#fm").form("load",row);
            controllerurl="/management/updateStudent";
        }
...
<div id="dlg" class="easyui-dialog" style="width: 570px;height: 350px;padding: 10px 20px"
	...
	<form id="fm" method="post">
		<table cellspacing="5px;">
			...
			<tr>
				<td>班级名称：</td>
				<td><input class="easyui-combobox" id="gradeId" name="gradeId"  data-options="panelHeight:'auto',editable:true,valueField:'id',textField:'gradeName',url:'/management/gradeComboList'"/></td>
				<td></td>
				<td>Email：</td>
